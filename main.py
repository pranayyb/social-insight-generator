...
LANGFLOW_ID = "7b501ee2-aed6-49c0-9d01-4a70e1430cef"
FLOW_ID = "57a2f049-a42a-4096-9d49-003b0d8d63ab"
APPLICATION_TOKEN = "AstraCS:pXzwHugPoaFUbCtSZEsyCYwL:cdb7b6fc7ab4d798b7abcfd83a69b9622d2581d02a18a5d2c0d6025f06e9fafe"
ENDPOINT = "insight"  # The endpoint name of the flow

# You can tweak the flow by adding a tweaks dictionary
# e.g {"OpenAI-XXXXX": {"model_name": "gpt-4"}}
# TWEAKS = {
#     "AstraDBCQLToolComponent-QQTfb": {},
#     "ChatOutput-iKhbK": {},
#     "Prompt-yPOSX": {},
#     "GroqModel-de1nQ": {},
#     "ParseData-b8LBM": {},
...
Run it like: python <your file>.py "your message here" --endpoint "your_endpoint" --tweaks '{"key": "value"}'""",
    ...
    parser.add_argument(
        "--output_type", type=str, default="chat", help="The output type"
    )
    parser.add_argument("--input_type", type=str, default="chat", help="The input type")
    parser.add_argument(
        "--upload_file", type=str, help="Path to the file to upload", default=None
    )
    parser.add_argument(
        "--components", type=str, help="Components to upload the file to", default=None
    )
    ...
    if args.upload_file:
        if not upload_file:
            ...
            raise ValueError(
                "You need to provide the components to upload the file to."
            )
        # tweaks = upload_file(
